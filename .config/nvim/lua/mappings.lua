...
vim.keymap.set("n", ":F", "<Cmd>e ~/.config/nvim/after/ftplugin/<CR>", {silent = true})
...
vim.keymap.set("n", "gof", "<Cmd>let g:FORMAT_ENABLED = !get(g:, 'FORMAT_ENABLED', 1)<Bar>let g:FORMAT_ENABLED<CR>", {silent = true})
