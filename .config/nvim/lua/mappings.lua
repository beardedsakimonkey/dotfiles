...
vim.keymap.set("n", "g.", repeat_last_edit, {})
...
vim.keymap.set("n", "yO", ":<c-u>let @\"='<c-r>=expand(\"%:p\")<CR>'<CR>", {silent = true})
vim.keymap.set("n", "con", "<Cmd>set number!<CR>", {silent = true})
vim.keymap.set("n", "coc", "<Cmd>set cursorline!<CR>", {silent = true})
vim.keymap.set("n", "cow", "<Cmd>set wrap!<CR>", {silent = true})
vim.keymap.set("n", "col", "<Cmd>set hlsearch!<CR>", {silent = true})
vim.keymap.set("n", "coi", "<Cmd>set ignorecase!<CR>", {silent = true})
