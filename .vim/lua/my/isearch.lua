...
local update_preview_debounced = debounce(update_preview, 200)
...
local function search(source, _show_preview)
    ...
    api.nvim_buf_set_keymap(input_buf, 'i', '<c-u>', '<cmd>lua require"my.isearch".scroll_preview_up()<cr>', opts)
...
return {
    ...
    scroll_preview_up   = function () scroll_preview(-1) end,
    scroll_preview_down = function () scroll_preview(1) end,
