...
" Last Updated: Sat Jun 20 13:17:26 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi User3 guifg=#d8a657 guibg=#665c54 guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi User3 ctermfg=214 ctermbg=241 cterm=NONE
  hi! link isearchCursorLine CursorLine
  hi! link isearchResults Normal
  hi! link isearchInput Normal
...
if s:t_Co >= 8
  ...
  hi User3 ctermfg=Yellow ctermbg=DarkGrey cterm=NONE
  hi! link isearchCursorLine CursorLine
  hi! link isearchResults Normal
  hi! link isearchInput Normal
