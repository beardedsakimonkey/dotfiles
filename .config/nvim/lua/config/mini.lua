...
ai.setup({n_lines = 50, mappings = {goto_right = "g]", inside_last = "il", inside = "i", around = "a", around_next = "an", inside_next = "in", goto_left = "g[", around_last = "al"}, custom_textobjects = {F = ts_spec({a = "@function.outer", i = "@function.inner"}), f = ts_spec({a = "@call.outer", i = "@call.inner"}), B = ts_spec({a = "@block.outer", i = "@block.inner"}), o = ts_spec({a = {"@conditional.outer", "@loop.outer"}, i = {"@conditional.inner", "@loop.inner"}}), g = _1_}, search_method = "cover_or_next"})
