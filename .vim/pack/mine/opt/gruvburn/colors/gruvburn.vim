...
" Last Updated: Thu May 28 22:37:00 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#32302f', '#ea6962', '#a8a920', '#d8a657',
        \ '#83a598', '#d3869b', '#8bba7f', '#cab081', '#32302f', '#ea6962',
        \ '#a8a920', '#d8a657', '#83a598', '#d3869b', '#8bba7f', '#cab081']
  if has('nvim')
  ...
  hi luaFunction guifg=#e78a4e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  unlet s:t_Co
  finish
endif
...
if s:t_Co >= 256
  ...
  hi luaFunction ctermfg=208 ctermbg=NONE cterm=NONE
  unlet s:t_Co
  finish
endif
...
if s:t_Co >= 8
  ...
  hi luaFunction ctermfg=DarkYellow ctermbg=NONE cterm=NONE
  unlet s:t_Co
  finish
endif
