...
vim.api.nvim_set_hl(0, "IncSearch", {bg = "#ffc17a", fg = "Black"})
...
vim.api.nvim_set_hl(0, "Identifier", {bg = "none", fg = "Black"})
vim.api.nvim_set_hl(0, "Function", {fg = "Black"})
vim.api.nvim_set_hl(0, "LineNr", {fg = "Burlywood4"})
vim.api.nvim_set_hl(0, "Statement", {bg = "none", fg = "MidnightBlue"})
vim.api.nvim_set_hl(0, "Keyword", {bg = "none", fg = "MidnightBlue"})
...
vim.api.nvim_set_hl(0, "Whitespace", {fg = "#bab28f"})
...
vim.api.nvim_set_hl(0, "ColorColumn", {bg = "#ccb3a9"})
...
vim.api.nvim_set_hl(0, "DiagnosticInfo", {fg = "Orange2"})
vim.api.nvim_set_hl(0, "DiagnosticHint", {fg = "Orange2"})
vim.api.nvim_set_hl(0, "DiagnosticUnderlineError", {bg = "#dda296"})
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", {bg = "#e5daa5"})
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo", {bg = "#dbd09d"})
vim.api.nvim_set_hl(0, "DiagnosticUnderlineHint", {bg = "#dbd09d"})
vim.api.nvim_set_hl(0, "DiagnosticSignError", {bg = "#c9c5b5", fg = "Red3"})
vim.api.nvim_set_hl(0, "DiagnosticSignWarn", {bg = "#c9c5b5", fg = "Orange3"})
vim.api.nvim_set_hl(0, "DiagnosticSignInfo", {bg = "#c9c5b5", fg = "Orange2"})
vim.api.nvim_set_hl(0, "DiagnosticSignHint", {bg = "#c9c5b5", fg = "Orange2"})
...
vim.api.nvim_set_hl(0, "UfindMatch", {bg = "none", bold = 1, fg = "#BD00BD"})
vim.api.nvim_set_hl(0, "UfindCursorLine", {link = "DiffChange"})
...
vim.api.nvim_set_hl(0, "@text.title1", {link = "markdownH1"})
vim.api.nvim_set_hl(0, "@text.title2", {link = "markdownH2"})
vim.api.nvim_set_hl(0, "@constant.builtin", {link = "Constant"})
vim.api.nvim_set_hl(0, "@function", {bold = 1, fg = "Black"})
vim.api.nvim_set_hl(0, "@function.call", {fg = "Blue3"})
vim.api.nvim_set_hl(0, "@keyword.operator", {link = "PreProc"})
vim.api.nvim_set_hl(0, "@keyword.return", {link = "PreProc"})
