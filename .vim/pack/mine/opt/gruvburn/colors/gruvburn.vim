...
" Last Updated: Wed Aug  5 21:32:01 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  " Light background
  let g:terminal_ansi_colors = ['#c1bbac', '#c14a4a', '#5e631c', '#8e5b0e',
        \ '#43575b', '#7f526f', '#4c7a5d', '#5e5146', '#c1bbac', '#c14a4a',
        \ '#5e631c', '#8e5b0e', '#43575b', '#7f526f', '#4c7a5d', '#5e5146']
  if has('nvim')
    let g:terminal_color_0 = '#c1bbac'
    let g:terminal_color_1 = '#c14a4a'
    let g:terminal_color_2 = '#5e631c'
    let g:terminal_color_3 = '#8e5b0e'
    let g:terminal_color_4 = '#43575b'
    let g:terminal_color_5 = '#7f526f'
    let g:terminal_color_6 = '#4c7a5d'
    let g:terminal_color_7 = '#5e5146'
    let g:terminal_color_8 = '#c1bbac'
    let g:terminal_color_9 = '#c14a4a'
    let g:terminal_color_10 = '#5e631c'
    let g:terminal_color_11 = '#8e5b0e'
    let g:terminal_color_12 = '#43575b'
    let g:terminal_color_13 = '#7f526f'
  ...
  hi FoldColumn guifg=#827466 guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi Folded guifg=#827466 guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=#5e5146 guibg=#2e2c2a guisp=NONE gui=NONE cterm=NONE
  hi IncSearch guifg=#eab04b guibg=#6b4223 guisp=NONE gui=NONE cterm=NONE
  hi Search guifg=#cec15c guibg=#5b5b26 guisp=NONE gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi Conceal guifg=#827466 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Cursor guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi CursorColumn guifg=NONE guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi CursorLine guifg=NONE guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#7c6f64 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi CursorLineNr guifg=#8e5b0e guibg=#c1bbac guisp=NONE gui=NONE cterm=NONE
  ...
  hi DiffText guifg=NONE guibg=#6b4223 guisp=NONE gui=NONE cterm=NONE
  hi Directory guifg=#5e631c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#c14a4a guibg=NONE guisp=NONE gui=underline cterm=underline
  hi WarningMsg guifg=#8e5b0e guibg=NONE guisp=NONE gui=bold cterm=bold
  hi ModeMsg guifg=#5e5146 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi MoreMsg guifg=#8e5b0e guibg=NONE guisp=NONE gui=bold cterm=bold
  hi MatchParen guifg=NONE guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi NonText guifg=#827466 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#4f3829 guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSbar guifg=NONE guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSel guifg=#ccc5b5 guibg=#a89984 guisp=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#ccc5b5 guibg=#a89984 guisp=NONE gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#7c6f64 guisp=NONE gui=NONE cterm=NONE
  hi Question guifg=#8e5b0e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi StatusLine guifg=#5e5146 guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi StatusLineNC guifg=#827466 guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#827466 guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi TabLineFill guifg=#5e5146 guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#5e5146 guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi VertSplit guifg=#ccc5b5 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi VisualNOS guifg=NONE guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi QuickFixLine guifg=#7f526f guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Debug guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi debugPC guifg=#c1bbac guibg=#5e631c guisp=NONE gui=NONE cterm=NONE
  hi debugBreakpoint guifg=#c1bbac guibg=#c14a4a guisp=NONE gui=NONE cterm=NONE
  hi Boolean guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Number guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Float guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreCondit guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Include guifg=#43575b guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Define guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Conditional guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Repeat guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Keyword guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Typedef guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Exception guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#43575b guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Error guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi StorageClass guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Tag guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Label guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Structure guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Operator guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Title guifg=#915a2d guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Special guifg=#8e5b0e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi SpecialChar guifg=#8e5b0e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Type guifg=#8e5b0e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Function guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi String guifg=#5e631c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Character guifg=#5e631c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi SpecialKey guifg=#43575b guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Underlined guifg=#43575b guibg=NONE guisp=NONE gui=underline cterm=underline
  hi User1 guifg=#c14a4a guibg=#ccc5b5 guisp=NONE gui=bold cterm=bold
  hi User2 guifg=#c1bbac guibg=#a96b2c guisp=NONE gui=NONE cterm=NONE
  hi User3 guifg=#5e631c guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi User4 guifg=#c14a4a guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi User5 guifg=#827466 guibg=#ccc5b5 guisp=NONE gui=NONE cterm=NONE
  hi isearchCursorLine guifg=#4f3829 guibg=#bcb6a7 guisp=NONE gui=NONE cterm=NONE
  hi! link isearchResults Normal
  hi! link isearchInput Normal
  hi! link isearchPreview Normal
  ...
  hi LspDiagnosticsWarning guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi LspDiagnosticsInformation guifg=#80a0ff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi LspDiagnosticsHint guifg=#80a0ff guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi LspDiagnosticsUnderlineHint guifg=NONE guibg=#1f3742 guisp=NONE gui=NONE cterm=NONE
  hi! link vimCommentString Comment
  hi helpNote guifg=#7f526f guibg=NONE guisp=NONE gui=bold cterm=bold
  hi helpHeadline guifg=#c14a4a guibg=NONE guisp=NONE gui=bold cterm=bold
  hi helpHeader guifg=#915a2d guibg=NONE guisp=NONE gui=bold cterm=bold
  hi helpURL guifg=#5e631c guibg=NONE guisp=NONE gui=underline cterm=underline
  hi helpHyperTextEntry guifg=#8e5b0e guibg=NONE guisp=NONE gui=bold cterm=bold
  hi helpHyperTextJump guifg=#8e5b0e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi helpCommand guifg=#4c7a5d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi helpExample guifg=#5e631c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi helpSpecial guifg=#43575b guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi helpSectionDelim guifg=#827466 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi htmlArg guifg=#8e5b0e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi javascriptFunction guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi javascriptReserved guifg=#43575b guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi javascriptValue guifg=#7f526f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi jsxComponentName guifg=#8e5b0e guibg=NONE guisp=NONE gui=bold cterm=bold
  hi jsxTagName guifg=#8e5b0e guibg=NONE guisp=NONE gui=bold cterm=bold
  hi jsxAttrib guifg=#8e5b0e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi reasonStorage guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi reasonModPath guifg=#43575b guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi rustFuncCall guifg=#5e5146 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi rustQuestionMark guifg=#915a2d guibg=NONE guisp=NONE gui=NONE cterm=NONE
