...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-rescript", "nvim-ts-autotag", "playground" },
    loaded = true,
    only_config = true
  },
...
vim.cmd [[au FileType rescript ++once lua require("packer.load")({'vim-rescript', 'nvim-treesitter-rescript'}, { ft = "rescript" }, _G.packer_plugins)]]
