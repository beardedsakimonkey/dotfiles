...
do
  vim.api.nvim_set_keymap("n", "gl", "g`.", {noremap = true})
end
do
...
do
  ...
  vim.api.nvim_set_keymap("n", "g.", "<Cmd>lua my__map__repeat_last_edit()<CR>", {noremap = true})
end
...
do
  vim.api.nvim_set_keymap("x", "*", "\"vy:let @/='<c-r>v'<bar>norm! n<CR>zzzv", {noremap = true, silent = true})
end
do
  vim.api.nvim_set_keymap("x", "#", "\"vy:let @/='<c-r>v'<bar>norm! N<CR>zzzv", {noremap = true, silent = true})
end
do
  vim.api.nvim_set_keymap("x", "g*", "\"vy:let @/='\\<<c-r>v\\>'<bar>norm! n<CR>zzzv", {noremap = true, silent = true})
end
do
  vim.api.nvim_set_keymap("x", "g#", "\"vy:let @/='\\<<c-r>v\\>'<bar>norm! N<CR>zzzv", {noremap = true, silent = true})
end
do
  vim.api.nvim_set_keymap("n", "g/", ":<c-u>let @/='\\<<c-r>=expand(\"<cword>\")<CR>\\>'<CR>:set hls<CR>", {noremap = true, silent = true})
end
do
  vim.api.nvim_set_keymap("x", "g/", "\"vy:let @/='<c-r>v'<Bar>set hls<CR>", {noremap = true, silent = true})
end
do
...
do
  ...
  vim.api.nvim_set_keymap("n", "]j", "<Cmd>lua my__map__jump_forward()<CR>", {noremap = true})
end
do
