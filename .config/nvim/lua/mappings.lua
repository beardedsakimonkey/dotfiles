...
vim.api.nvim_set_keymap("n", "g;", "", {callback = _12_, noremap = true})
local function _13_()
  return nav_change_list("g,")
end
vim.api.nvim_set_keymap("n", "g'", "", {callback = _13_, noremap = true})
...
vim.api.nvim_set_keymap("n", "<C-l>", "", {callback = _14_, noremap = true, silent = true})
local function _15_()
  return navigate("h")
end
vim.api.nvim_set_keymap("n", "<C-h>", "", {callback = _15_, noremap = true, silent = true})
local function _16_()
  return navigate("j")
end
vim.api.nvim_set_keymap("n", "<C-j>", "", {callback = _16_, noremap = true, silent = true})
local function _17_()
  return navigate("k")
end
vim.api.nvim_set_keymap("n", "<C-k>", "", {callback = _17_, noremap = true, silent = true})
...
vim.api.nvim_set_keymap("n", "[e", "", {callback = _18_, noremap = true})
local function _19_()
